...
#define RADIO_MAX_CHANNELS              (32+1+59)
...
typedef enum
{
    ...
    RADIO_CHAN_WIDTH_160_PLUS_160MHZ, 
...
static inline uint32_t radio_get_chan_index(
        radio_type_t                type,
        uint32_t                    chan)
{
    switch (type)
    {
        ...
        case RADIO_TYPE_5GU:
            return (chan - 36)/4;
        case RADIO_TYPE_6G:
            return 33 + ((chan == 1) ? 0 : ((chan - 1) / 4));
        default:
            return RADIO_MAX_CHANNELS - 1;
    }
}
                ...
                radio_type_t                radio_type)
{
    ...
    switch (radio_type) {
        ...
        case RADIO_TYPE_5GU:
            ...
            break;
        case RADIO_TYPE_6G:
            return radio_type - 3; //XXX TODO fix 6e
            break;
        default:
            break;
    }
